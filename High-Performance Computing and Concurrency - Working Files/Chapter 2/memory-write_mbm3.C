...
BENCHMARK_TEMPLATE1(BM_write_seq, Word) ARGS(1);
BENCHMARK_TEMPLATE1(BM_write_seq, Word) ARGS(2);
BENCHMARK_TEMPLATE1(BM_write_seq, Word) ARGS(4);
//BENCHMARK_TEMPLATE1(BM_write_rand, Word) ARGS(1);
//BENCHMARK_TEMPLATE1(BM_write_norand, Word) ARGS(1);
